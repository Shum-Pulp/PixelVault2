...
(function () {
  ...
  function updateHUD(){
    ...
    try{ localStorage.setItem("invaders_high", String(state.high)); }catch {}
  ...
  function formationBounds(F){
    ...
    if(alive===0) return {alive:0,minX:0,maxX:0,maxY:0};
    return {alive,minX,maxX,maxY};
  }
  ...
  function tryShoot(){
    ...
    state.bullets.push({x:p.x+PLAYER_W/2-BULLET_W/2,y:p.y-10,vy:-BULLET_SPEED,w:BULLET_W,h:BULLET_H});
